...
//                    arrayAdapter.notifyDataSetChanged();
            ...
            } else if(resultCode == DetailActivity.savePokemonIntoComputerLevelUp) {
                String pokemonName2 = data.getStringExtra(OwnedPokemonInfo.nameKey);
                if(arrayAdapter != null) {
                    OwnedPokemonInfo ownedPokemonInfo = arrayAdapter.getItemWithName(pokemonName2);
                    ownedPokemonInfo.level = data.getIntExtra(OwnedPokemonInfo.levelUpKey, 0);
